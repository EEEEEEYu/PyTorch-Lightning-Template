...
class ModelInterface(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        train_step_top1_acc = multiclass_accuracy(train_out_logits, train_labels, num_classes=self.num_classes, average='macro', top_k=1)
        train_step_top5_acc = multiclass_accuracy(train_out_logits, train_labels, num_classes=self.num_classes, average='macro', top_k=5)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        val_step_top1_acc = multiclass_accuracy(val_out_logits, val_labels, num_classes=self.num_classes, average='macro', top_k=1)
        val_step_top5_acc = multiclass_accuracy(val_out_logits, val_labels, num_classes=self.num_classes, average='macro', top_k=5)
    ...
    def test_step(self, batch, batch_idx):
        ...
        test_step_top1_acc = multiclass_accuracy(test_out_logits, test_labels, num_classes=self.num_classes, average='macro', top_k=1)
        test_step_top5_acc = multiclass_accuracy(test_out_logits, test_labels, num_classes=self.num_classes, average='macro', top_k=5)
